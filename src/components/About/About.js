  ...
  return (
    <div className='about-container'>
      ...
      <div className=''>
        ...
        <div className='text-lg'>I'm <strong>Ugwu Chukwuebuka K</strong>, a passionate and dedicated Frontend Developer. I believe that the power of technology lies in its ability to create meaningful and intuitive user experiences. With a combination of creativity and technical expertise, I strive to build visually stunning and user-friendly websites that leave a lasting impression.
        <br />
        <br />
